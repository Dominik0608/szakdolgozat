<head>
    ...
    <!-- font awesome -->
    <script src="https://kit.fontawesome.com/3d87ca1f51.js" crossorigin="anonymous"></script>
...
<body>
    ...
    <!-- nagyítható képek (viewerjs) -->
    <script>
        $(document).ready(function() {
            const zoomable = document.querySelectorAll(".viewerjs");
